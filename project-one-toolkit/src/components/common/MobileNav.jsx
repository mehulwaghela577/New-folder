                            ...
                            <div className="row w-100 gx-0">
                                <div className="col-8">
                                    <ul className="nav nav-tabs d-flex border-0 align-items-center justify-content-between" id="myTab" role="tablist">
                                        ...
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-mb" type="button" role="tab" aria-controls="contact-mb" aria-selected="false">Updates <span className="red"></span></button>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div className="row gx-0 h-100 align-items-center">
                <div className="col-6 left">
                    <a href="" className="brand">
                        <img src={tLogo} alt="Logo" className="img-fluid" />
                    </a>
                </div>
